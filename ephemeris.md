...
Afiche le résultat sous forme d'une page HTML (via la navigateur) accompagné du diagramme solaire de la journée (zimut et hauteur solaire selon l'heure de la journée) aisni que la phase de la lune.
...
Bibliothèque : astral 1.6, numpy (intégré à Python) 
Affichage : HTML5+CSS

## Données calculées et affichées
### Jour
* Dawn (Aube) : période avant le lever du soleil, entre le nuit et le jour (6 à 0° sous l'horizon)
* Sunrise (Lever du soleil) : momznt ou le soleil apparait à l'horizon (Aurore)
* Noon (Midi) : moment ou le soleil est au plus haut
* Midnight (Minuit) : moment ou le soleil est plus bas sous l'horizon
* Sunset (Coucher du soleil) : moment ou le soleil disparait derrière l'horizon
